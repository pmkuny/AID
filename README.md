...
- **DOC (Documentation AI Disclosure)** - This content was **primarily** written by a human, with AI-generated documentation. All documentation and documentation systems presented in this repository should be considered AI-generated.

- **TEST (Testing AI Disclosure)** - The core application logic is human-written, but the test suites, test cases, or test data were generated by AI.

- **INFRA (Infrastructure AI Disclosure)** - The infrastructure as code (Terraform, Nix, Kubernetes manifests) or CI/CD pipelines were bootstrapped or generated by AI.

- **HARD (Hardware AI Disclosure)** - AI was used in the design of hardware components, PCB layouts, or firmware logic (HDL/Verilog).
